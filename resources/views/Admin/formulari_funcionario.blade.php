     ...
     <div class="col-lg-12">
            <div class="card">
                <div class="card-header">Cadastrar Funcionario</div>
                    <div class="card-body">
                        <hr>
                            <form action="{{route('enviar_dado')}}" method="post" enctype="multipart/form-data" novalidate="novalidate">
                               @csrf
                                       ...
                                       <div class="form-group">
                                             <label for="cc-exp" class="control-label mb-1">Telemovel</label>
                                               <input id="cc-exp" name="terminal" type="tel" class="form-control cc-exp" placeholder="Telemovel" data-val="true" data-val-required="Please enter the card expiration"
                                                ...
                                                <div class="col-6">
                                                    <label for="exampleInputCity1">Cargo</label>
                                                    <div class="input-group">
                                                        <input type="text"  name="cargo" class="form-control" id="exampleInputCity1" placeholder="Cargo">
                                                    </div>
                                                    @error('cargo')
                                                       <span class = "text-danger">{{ $message }}</span>
                                                     @enderror
