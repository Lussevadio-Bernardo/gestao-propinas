...
<head>
	...
	<title>Sistema de Gestão de Propinas</title>
	<!-- Bootstrap CSS -->
	<link rel="stylesheet" href="{{asset('estilo/css/bootstrap.css')}}">
	<link rel="stylesheet" href="{{asset('estilo/vendors/linericon/style.css')}}">
	<link rel="stylesheet" href="{{asset('estilo/css/font-awesome.min.css')}}">
	<link rel="stylesheet" href="{{asset('estilo/vendors/owl-carousel/owl.carousel.min.css')}}">
	<link rel="stylesheet" href="{{asset('estilo/vendors/lightbox/simpleLightbox.css')}}">
	<link rel="stylesheet" href="{{asset('estilo/vendors/nice-select/css/nice-select.css')}}">
	<link rel="stylesheet" href="{{asset('estilo/vendors/animate-css/animate.css')}}">
	<!-- main css -->
				...
				<div class="row align-items-center">
					<div class="col-lg-6 col-sm-6 col-4 header-top-left">
						<a href="tel:+9530123654896">
							...
							<span class="text">
								<span class="text">+244 945 831 977</span>
							</span>
						</a>
						<a href="mailto:support@colorlib.com">
							<span class="lnr lnr-envelope"></span>
							<span class="text">
								<span class="text">lussevadiobernardo1996@gmail.com</span>
							</span>
						</a>
					</div>
					<div class="col-lg-6 col-sm-6 col-8 header-top-right">
						<a href="#" type="button" class="btn btn-primary" id="btnLogin" data-bs-toggle="modal" data-bs-target="#modalLogin">Login</a>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="container">
					...
					<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
						<ul class="nav navbar-nav menu_nav ml-auto">
							<li class="nav-item active"><a class="nav-link" href="{{route('inicio')}}">Home</a></li>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
	 		 ...
	 		 <form action="{{route('loga')}}" method="post"class="row g-3">
			    @csrf
					<div class="col-md-10">
						<label for="validationDefault01" class="form">Nome de Usuario</label>
						<input type="text" name="nome" class="form-control" id="validationDefault01" placeholder="e-mail" required>
					</div>
					<div class="col-md-10">
						<label for="validationDefault01" class="form-label">Palavra passe</label>
						<input type="password" name="pass" class="form-control" id="validationDefault01" placeholder="palavra passe" required>
					</div>
					<div class="col-12">
	...
	<script src="{{asset('estilo/js/jquery-3.2.1.min.js')}}"></script>
	<script src="{{asset('estilo/js/popper.js')}}"></script>
	<script src="{{asset('estilo/js/bootstrap.min.js')}}"></script>
	<script src="{{asset('estilo/js/stellar.js')}}"></script>
	<script src="{{asset('estilo/js/countdown.js')}}"></script>
	<script src="{{asset('estilo/vendors/nice-select/js/jquery.nice-select.min.js')}}"></script>
	<script src="{{asset('estilo/vendors/owl-carousel/owl.carousel.min.js')}}"></script>
	<script src="{{asset('estilo/js/owl-carousel-thumb.min.js')}}"></script>
	<script src="{{asset('estilo/js/jquery.ajaxchimp.min.js')}}"></script>
	<script src="{{asset('estilo/vendors/counter-up/jquery.counterup.js')}}"></script>
	<script src="{{asset('estilo/js/mail-script.js')}}"></script>
	<!--gmaps Js-->
	<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCjCGmQ0Uq4exrzdcL6rvxywDDOvfAu6eE"></script>
	<script src="{{asset('estilo/js/gmaps.min.js')}}"></script>
	<script src="{{asset('estilo/js/theme.js')}}"></script>
