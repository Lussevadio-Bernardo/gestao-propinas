...
@section('conteudo') 
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <hr>
                                        <form action="{{route('enviar_dado_curso')}}" method="post" enctype="multipart/form-data" novalidate="novalidate">
                                        @csrf
                                            <div class="form-group">
                                                <label for="cc-payment" class="control-label mb-1">Nome do curso</label>
                                                <input id="cc-pament" name="nome" type="text" class="form-control"  placeholder="Nome do curso">
                                                @error('nome')
